...
Tabo uses the CMake build system and a top-level [Makefile](Makefile) that
...
* Change to the root of the source code directory, change to the most recent release branch, and build:
    ...
    *Note*: The instructions above will compile the most stable release of the
    Tabo software. If you would like to use and test the most recent software,
...
* Add `PATH="$PATH:$HOME/tabo/build/release/bin"` to `.profile`

* Run Tabo with `tabod --detach`
...
* Clone Tabo and checkout the most recent release version:
    ...
    ```bash
    git clone https://github.com/taboProtocol/tabo.git
    cd tabo
...
* Add `export PATH="$PATH:$HOME/tabo/build/release/bin"` to `$HOME/.profile`
...
* Then, install the dependencies for Tabo except for `libunwind` and `libboost-all-dev`
...
* From here, follow the [general Raspberry Pi instructions](#on-the-raspberry-pi) from the "Clone Tabo and checkout most recent release version" step.
...
* If you would like a specific [version/tag](https://github.com/taboprotocol/tabo/tags), do a git checkout for that version. eg. 'v0.1.0.1'. If you don't care about the version and just want binaries from master, skip this step:
...
To list all available options, run `./bin/tabod --help`.  Options can be
